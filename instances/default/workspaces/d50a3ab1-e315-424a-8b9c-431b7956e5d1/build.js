...
// Config can specify a variant-specific template
const templateFile = config.template || 'template.html';
const template = fs.readFileSync(path.join(__dirname, 'src', templateFile), 'utf8');
...
// Config can override component list for variant-specific builds
const componentOrder = config.components || [
  'storage.js',
  'setup.js',
  'theme.js',
  'navigation.js',
